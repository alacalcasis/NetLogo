...
@#$#@#$#@
<experiments>
  <experiment name="EfectoDFertilidadAzulSobreExtincionRoja" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="EfectoDFertilidadAzulSobreExtincionRoja_red-count" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>red-count = 0</exitCondition>
    <metric>ticks</metric>
    <metric>red-count</metric>
    <steppedValueSet variable="blue-fertility" first="2.1" step="0.1" last="5"/>
    <enumeratedValueSet variable="carrying-capacity">
      <value value="1000"/>
    </enumeratedValueSet>
