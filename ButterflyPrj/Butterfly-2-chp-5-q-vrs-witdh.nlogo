...
;; World procedures and reporters

to setup
  ;;ca limpia todo (tortugas, trazas, plots) incluyendo plots
  clear-drawing ;; limpia solamente las trazas de las tortugas
  ct ;; mata todas las tortugas para volverlas a crear
  ask patches
  [
    P-initialize
  ]
...
;; Turtles procedures and reporters
to T-initialize
  set size 2
  setxy 85 95
...
;; Patches procedures and reporters
to P-initialize
