...
to setup ;; Para inicializar la simulación.
  ca            ;; Para inicializar estado del sistema.
...
to go ;; Para ejecutar la simulación.
  ask turtles [T-move]
  tick
  if ticks >= 1000 [stop] ;; En caso de que la simulación esté controlada por cantidad de ticks.
end
...
to T-move ;; Se debería cambiar el nombre para que represente algo signficativo en la simulación.
