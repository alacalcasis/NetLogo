patches-own [
  ...
  wall?                ;; true on walls patches, false elsewhere
]
...
to setup-patches
  ...
  [ setup-nest
    setup-food
    setup-walls ;; instala las paredes del laberinto
    recolor-patch ]
end
...
to setup-walls
  ;; instala las paredes del laberinto
  ;; al inicio podría generar al azar paredes
end
...
to wiggle  ;; turtle procedure
  rt random 40
  lt random 40
  if not can-move? 1 [ rt 180 ] ;; aquí tengo que agregar la condición or(wall at front? o algo así )
end
