...
to setup ;; Para inicializar la simulación.
  ...
  if limita-peatones [ set peatones-evacuando n-of N-peatones peatones ]
...
to go ;; Para ejecutar la simulación.
  ...
  ; ask peatones with [distance ptoEncObj > 5] [ peatones-seguir-ruta 7 90 5 2 ]
  ifelse limita-peatones
  [ ask peatones-evacuando with [ ticsal <= ticks and distance ptoEncObj > 5 and not llegue ] [ peatones-seguir-ruta 7 70 ]]
  [ ask peatones with [ ticsal <= ticks and distance ptoEncObj > 5 and not llegue ] [ peatones-seguir-ruta 7 70 ]]
...
to peatones-corregir-heading [ rv av ]
  while [not any? patches in-cone rv (av + 20) with [ pcolor = 54 or pcolor = 55 or pcolor = 56 ]] [rt 1]
  set heading towards min-one-of patches in-cone rv (av + 20) with [ pcolor = 54 or pcolor = 55 or pcolor = 56 ] [distance self]
end
